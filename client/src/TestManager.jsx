  ...
  return (
    <section className="tm-dashboard">
      ...
      <div className="tm-metrics-grid">
        ...
        <div className="tm-metric-card">
          <div className="tm-metric-icon gold">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="tm-metric-card">
          <div className="tm-metric-icon seal">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className="tm-form-group">
                    ...
                    {audioUrl && (
                      <div className="tm-asset-card">
                        <div className="tm-asset-info" style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
